...
axios__WEBPACK_IMPORTED_MODULE_1___default.a.get('http://localhost:4000/api/users').then(users => {
  console.log(users);
}).catch(err => {
  console.log(err);
});
...
module.exports = __webpack_require__(/*! /Users/lambda_school_loaner_149/Desktop/Back-End/Node/Week3/webauth-i-challenge/last-backend-project/pages/index.js */"./pages/index.js");
